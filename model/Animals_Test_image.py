...
def get_arg():
    ...
    parse.add_argument('-i', '--image_path', type=str, default="model/test_images/test_1.jpeg")
    parse.add_argument('-c', '--checkpoint_path', type=str, default="model/trained_models/best.pt")
...
def test(args):
    ...
    print(type(categories[max_index]))
    print(type(max_value[0].item()))
